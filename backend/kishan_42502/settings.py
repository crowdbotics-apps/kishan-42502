"""
Django settings for kishan_42502 project.
...
ROOT_URLCONF = 'kishan_42502.urls'
...
WSGI_APPLICATION = 'kishan_42502.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kishan_42502 API",
    "DESCRIPTION": "API documentation for kishan_42502 App",
    "VERSION": "v1",
}
